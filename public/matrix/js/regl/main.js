...
export default async (canvas, config) => {
	...
	// PORT PATCH: use addEventListener (removable on teardown) and drop the
	// global dblclick-fullscreen handler — undesirable for a background canvas.
	...
	// PORT PATCH: expose a teardown so a React component can stop the render
	// loop, drop the resize listener, and free the WebGL context on unmount.
	return () => {
		tick.cancel();
