...
import {ThemeId, ThemeProvider, useTheme} from 'components/ThemeProvider'
          ...
          <ProjectSectionColumns>
            ...
            <div className={styles.sidebarImages}>
              <Image
                ...
                src={{src: imageSnappfoodWelcomePageLarge as string}}
                placeholder={{src: imageSnappfoodWelcomePlaceholder as string}}
                alt='Snappfood welcome page'
                sizes={`(max-width: ${media.mobile}px) 50vw, 25vw`}
              />
              <Image
                className={styles.sidebarImage}
                src={{src: imageSnappfoodHomePageLarge as string}}
                placeholder={{src: imageSnappfoodHomePagePlaceholder as string}}
