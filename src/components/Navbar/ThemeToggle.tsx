...
export const ThemeToggle = ({isMobile, ...rest}: ThemeToggleProps) => {
  ...
  return (
    <Button iconOnly className={styles.toggle} data-mobile={isMobile} aria-label='Toggle theme' onClick={() => dispatch({type: 'toggleTheme'})} {...rest}>
      <svg aria-hidden className={styles.svg} width='38' height='38' viewBox='0 0 38 38'>
        ...
        <path className={styles.path} d='M19 3v7M19 35v-7M32.856 11l-6.062 3.5M5.144 27l6.062-3.5M5.144 11l6.062 3.5M32.856 27l-6.062-3.5' />
