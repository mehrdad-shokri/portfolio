              ...
              <ProjectSectionText as='div'>
                <List>
                  <ListItem>
                    ...
                    as my text editor, with the Atom One Dark theme and Operator
                    Mono as my typeface of choice.
                  </ListItem>
                  <ListItem>
                    Firefox is my main browser for both development and general
                    use.
                  </ListItem>
                  <ListItem>
                    <Link href='https://reactjs.org/'>React</Link> is my front
                    end Javascript library of choice. The component-centric
                    mental model is the first thing that truly made sense to me
                    as a designer.
                  </ListItem>
                  <ListItem>
                    For 3D effects and image shaders I use{' '}
                    <Link href='https://threejs.org/'>three.js</Link>. It has a
                    bit of a learning curve but you can do some really powerful
                    stuff with it.
                  </ListItem>
                  <ListItem>
                    For CSS I’ve used a myriad pre-processors and css-in-js
                    solutions like styled-components, but these days I’m using
                    vanilla CSS with{' '}
                    <Link href='https://postcss.org/'>PostCSS</Link> to get
                    upcoming CSS features today.
                  </ListItem>
                  <ListItem>
                    ...
                    , it’s a great way to add spring animations to React and
                    three.js.
                  </ListItem>
                  <ListItem>
